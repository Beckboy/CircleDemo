...
public class ScalableTextureView extends TextureView {
    ...
    public void setContentX(int contentX) {
        mContentX = contentX - (getMeasuredWidth() - getScaledContentWidth()) / 2;
        updateMatrixTranslate();
    }

    public void setContentY(int contentY) {
        mContentY = contentY - (getMeasuredHeight() - getScaledContentHeight()) / 2;
        updateMatrixTranslate();
    }
    ...
    public void setmContentScale(float contentScale) {
