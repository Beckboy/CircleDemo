package com.example.hunter_j.hunter_circledemo.widgets.videolist.widget;
...
public class TextureVideoView extends ScalableTextureView
    ...
    public interface MediaPlayerCallback{
        ...
        void onVedioSizeChanged(MediaPlayer mp, int width, int height);
    ...
    public void setmMediaPlayerCallback(MediaPlayerCallback mediaPlayerCallback) {
...
//            am.abandonAudioFocus(null);
    ...
    private void openVideo(){
        ...
        try {
            ...
            if (SHOW_LOGS) Log.w(TAG, "Unable to open content: "+ mUri, e);
    ...
    public void setVideoPath(String path){
        setVedioURI(Uri.parse(path));
    }

    public void setVedioURI(Uri uri){
    ...
    public void onBufferingUpdate(final MediaPlayer mediaPlayer, final int percent) {
        if (mMediaPlayerCallback != null){
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if (mMediaPlayerCallback != null){
                        mMediaPlayerCallback.onBufferingUpdate(mediaPlayer, percent);
                    }
                }
            });
        }
    ...
    public void onCompletion(final MediaPlayer mediaPlayer) {
        ...
        if (mMediaPlayerCallback != null){
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if (mMediaPlayerCallback != null){
                        mMediaPlayerCallback.onCompletion(mediaPlayer);
                    }
                }
            });
        }
    ...
    public boolean onInfo(final MediaPlayer mediaPlayer, final int what, final int extra) {
        if (mMediaPlayerCallback != null){
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if (mMediaPlayerCallback != null){
                        mMediaPlayerCallback.onInfo(mediaPlayer, what, extra);
                    }
                }
            });
        }
    ...
    public void onPrepared(final MediaPlayer mediaPlayer) {
        ...
        if (mCurrentState !=  STATE_PREPARING || mTargetState != STATE_PREPARING){
            return;
        }
...
//            mute();
        ...
        if (mMediaPlayerCallback != null){
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if (mMediaPlayerCallback != null){
                        mMediaPlayerCallback.onPrepared(mediaPlayer);
                    }
                }
            });
        }
    ...
    public void onVideoSizeChanged(final MediaPlayer mediaPlayer, final int width, final int height) {
        if (mMediaPlayerCallback != null){
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    mMediaPlayerCallback.onVedioSizeChanged(mediaPlayer,width,height);
                }
            });
        }
    }
